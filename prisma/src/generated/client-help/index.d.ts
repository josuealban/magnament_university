...
export namespace Prisma {
  ...
  */
  ...
  export type SystemLogOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "level" | "message" | "context" | "stack" | "createdAt", ExtArgs["result"]["systemLog"]>
  ...
  interface SystemLogFieldRefs {
    ...
    readonly stack: FieldRef<"SystemLog", 'String'>
  ...
  export type SystemLogWhereInput = {
    ...
    stack?: StringNullableFilter<"SystemLog"> | string | null
  ...
  export type SystemLogScalarWhereWithAggregatesInput = {
    ...
    stack?: StringNullableWithAggregatesFilter<"SystemLog"> | string | null
